...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createAccountBtn.setOnClickListener((View v) -> createAccount());
    ...
    void createAccount() {
        ...
        if (validateData(email, password, confirmPassword)) {
            ...
            createAccountIncFireBase(email, password);
        }
    }

    void createAccountIncFireBase(String email, String password) {
    ...
    boolean validateData(String email, String password, String confirmPassword) {
        ...
        if (password.length() < 6) {
            passwordEditText.setError("Password must have at least 6 letters");
            return false;
        }
